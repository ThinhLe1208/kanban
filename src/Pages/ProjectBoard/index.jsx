...
import { getProjectDetailSagaAction } from 'redux/sagas/actions/projectAction';
...
export default function ProjectBoard() {
  ...
  const breadCrumbList = [{ href: '/', title: 'Home' }, { href: '/project', title: 'Project' }, { title: projectName }];
