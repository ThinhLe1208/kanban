...
export default function Offcanvas() {
    const { isOpen, title, icon, aceptBtn, showBtn, offcanvasContent, handleSubmitOffcanvas } = useSelector(state => state.offcanvasReducer);
        ...
        <Drawer
            ...
            extra={showBtn ?
                <Space>
                    ...
                    <Button type='primary' onClick={handleSubmitOffcanvas}>{aceptBtn}</Button>
                </Space> :
                <div className={cx("closeBtn")} onClick={handlehideOffcanvas}><CloseOutlined /></div>
            }
        >
            {offcanvasContent}
        </Drawer>
