...
export default function Column({ colDetail, index }) {
    ...
    const handleClickAddIssueBtn = () => {
        dispatch(setOffcanvas({ title: 'Create Issue', icon: <FontAwesomeIcon icon={faFileCirclePlus} />, aceptBtn: 'Create', showBtn: true, offcanvasContent: <CreateTaskForm /> }));
    };
    ...
    const items = [
        {
            label: <Space><FontAwesomeIcon icon={faPenToSquare} /><span>Rename list</span></Space>,
            key: '0',
        },
        {
            label: <Space><FontAwesomeIcon icon={faStar} /><span>Add to favorites</span></Space>,
            key: '1',
        },
        {
            label: <Space><FontAwesomeIcon icon={faHardDrive} /><span>Archive list</span></Space>,
            key: '2',
        },
        {
            type: 'divider',
        ...
        {
            label: <Space style={{ color: '#e46a76' }}><FontAwesomeIcon icon={faTrashCan} /><span>Remove</span></Space>,
            key: '4',
        },
    ];
